...
main.innerHTML = "";
  ...
  // 5. Sort the array
  parksArray.sort((parkA, parkB) => {
    const parkARating = parseFloat(parkA.querySelector(".rating-display.stat .value").innerText);
    const parkBRating = parseFloat(parkB.querySelector(".rating-display.stat .value").innerText);
